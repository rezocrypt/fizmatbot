...
print_error_help()
{
	...
	echo -ne "    ARGUMENT REPEAT ERROR      : You wrote "
...
print_how_to_use_help()
{
	...
	echo -n "pcinfo -r"
	choose_color "green"
	echo -n " which will print about ram bat"
	...
	choose_color "green"
	echo  " But remember you cannot use same argument" \
	" multiple times else you will get error."
	echo -ne "If you want to print information"
	echo -e "without colors use  \033[1;31mpcinfo" \
	" --no-color  \033[1;32mas second or third argument (not first)."
	echo -e "And if you want clear screen before printing information" \
	" just write  \033[1;31mpcinfo --clear-screen."
}
# Function for help option
help_info()
{
	fill_line
	print_paragraph "PcInfo HELP"
	print_argument_help
	print_option_help
	print_error_help
	print_how_to_use_help	
...
{
	echo -ne "\033[1;31mERROR: WRONG_ARGUMENT_ERROR"
	echo -e "\033[1;33m\n\nYou do not use any argument."
	echo -e "Try again with writing argument.\n"
	echo -e "If you need help run script with argument -h"
}
...
{
	echo -e "\033[1;31mERROR: ARGUMENT_REPEAT_ERROR\033[1;33m\n"
	echo -ne "You repeated the same argument for more"
